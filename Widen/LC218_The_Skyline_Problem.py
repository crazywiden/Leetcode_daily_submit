...
# sweep line + hash heap implementation
# Runtime: 172 ms, faster than 30.06% of Python3 online submissions for The Skyline Problem.
# Memory Usage: 18.5 MB, less than 10.00% of Python3 online submissions for The Skyline Problem.
class HashHeap:
    
    def __init__(self, desc=False):
        self.hash = dict() # key is the value of an item, value is the index
        self.heap = []
        self.desc = desc
    ...
    def push(self, item):
        ...
        self.hash[item] = self.size - 1  # what if two item have the same value?
    ...
    def remove(self, item):
        ...
        del self.hash[item]  # delete from hash table
        self.heap.pop()  # pop from heap
